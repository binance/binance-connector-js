# Binance JavaScript Mining Connector
...
[![npm version](https://badge.fury.io/js/@binance%2Fmining.svg)](https://badge.fury.io/js/@binance%2Fmining)
[![npm Downloads](https://img.shields.io/npm/dm/@binance/mining.svg)](https://www.npmjs.com/package/@binance/mining)
![Node.js Version](https://img.shields.io/badge/Node.js-%3E=22.12.0-brightgreen)
[![Socket Badge](https://socket.dev/api/badge/npm/package/@binance/mining)](https://socket.dev/npm/package/@binance/mining)
[![Docs](https://img.shields.io/badge/docs-online-blue?style=flat-square)](https://binance.github.io/binance-connector-js/modules/_binance_mining.html)
...
For detailed information, refer to the [Binance API Documentation](https://developers.binance.com/docs/mining).
