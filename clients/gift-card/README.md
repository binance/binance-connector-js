# Binance JavaScript Gift Card Connector
...
[![Socket Badge](https://socket.dev/api/badge/npm/package/@binance/giftcard)](https://socket.dev/npm/package/@binance/giftcard)
...
For detailed information, refer to the [Binance API Documentation](https://developers.binance.com/docs/gift_card).
