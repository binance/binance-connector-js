...
const MarketDataApiAxiosParamCreator = function (configuration: ConfigurationRestAPI) {
    return {
         ...
         * @param {string} faceToken The token you want to buy, example: BNB. If faceToken = baseToken, it's the same as createCode
         * endpoint.
         ...
         * @param {string} [externalUid] Each external unique ID represents a unique user on the partner platform. The function helps you to
