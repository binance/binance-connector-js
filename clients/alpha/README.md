# Binance JavaScript Alpha Connector
...
[![npm version](https://badge.fury.io/js/@binance%2Falpha.svg)](https://badge.fury.io/js/@binance%2Falpha)
[![npm Downloads](https://img.shields.io/npm/dm/@binance/alpha.svg)](https://www.npmjs.com/package/@binance/alpha)
![Node.js Version](https://img.shields.io/badge/Node.js-%3E=22.12.0-brightgreen)
[![Socket Badge](https://socket.dev/api/badge/npm/package/@binance/alpha)](https://socket.dev/npm/package/@binance/alpha)
[![Docs](https://img.shields.io/badge/docs-online-blue?style=flat-square)](https://binance.github.io/binance-connector-js/modules/_binance_alpha.html)
