# Binance JavaScript Fiat Connector
...
[![npm version](https://badge.fury.io/js/@binance%2Ffiat.svg)](https://badge.fury.io/js/@binance%2Ffiat)
[![npm Downloads](https://img.shields.io/npm/dm/@binance/fiat.svg)](https://www.npmjs.com/package/@binance/fiat)
![Node.js Version](https://img.shields.io/badge/Node.js-%3E=22.12.0-brightgreen)
[![Socket Badge](https://socket.dev/api/badge/npm/package/@binance/fiat)](https://socket.dev/npm/package/@binance/fiat)
[![Docs](https://img.shields.io/badge/docs-online-blue?style=flat-square)](https://binance.github.io/binance-connector-js/modules/_binance_fiat.html)
...
For detailed information, refer to the [Binance API Documentation](https://developers.binance.com/docs/fiat).
...
If you are upgrading to the new modularized structure, refer to the [Migration Guide](./docs/migration_guide_fiat_connector.md) for detailed steps.
