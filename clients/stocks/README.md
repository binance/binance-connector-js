# Binance JavaScript Stocks Connector
...
[![npm version](https://badge.fury.io/js/@binance%2Fstocks.svg)](https://badge.fury.io/js/@binance%2Fstocks)
[![npm Downloads](https://img.shields.io/npm/dm/@binance/stocks.svg)](https://www.npmjs.com/package/@binance/stocks)
![Node.js Version](https://img.shields.io/badge/Node.js-%3E=22.12.0-brightgreen)
[![Socket Badge](https://socket.dev/api/badge/npm/package/@binance/stocks)](https://socket.dev/npm/package/@binance/stocks)
[![Docs](https://img.shields.io/badge/docs-online-blue?style=flat-square)](https://binance.github.io/binance-connector-js/modules/_binance_stocks.html)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

This is a client library for the Binance Stocks API, enabling developers to interact programmatically with Binance Stocks. The library provides tools to access trade U.S.-listed stocks and ETFs programmatically through a secure and developer-friendly API.
...
client.websocketStreams
    ...
    .then((connection: StocksWebsocketStreams.WebsocketStreamsConnection) => {
        const stream = connection.calendarStream();
        stream.on('message', (data: StocksWebsocketStreams.CalendarStreamResponse) => console.info(data));
    })
    .catch((err) => console.error(err));
```
...
client.websocketStreams
    ...
    .then((connection: StocksWebsocketStreams.WebsocketStreamsConnection) => {
        ...
        setTimeout(() => {
            stream.unsubscribe();
            console.log('Unsubscribed from calendar stream');
        }, 10000);
    })
    .catch((err) => console.error(err));
```

If `wsURL` is not provided, it defaults to `wss://nbstream.binance.com/equity`.
