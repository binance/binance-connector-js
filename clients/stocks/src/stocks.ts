...
export interface ConfigurationStocks {
...
export class Stocks {
    ...
    constructor(config: ConfigurationStocks) {
        ...
        if (config?.configurationRestAPI) {
            ...
            configRestAPI.basePath = configRestAPI.basePath || STOCKS_REST_API_PROD_URL;
        ...
        if (config?.configurationWebsocketStreams) {
            ...
            configWebsocketStreams.wsURL =
                configWebsocketStreams.wsURL || STOCKS_WS_STREAMS_PROD_URL;
