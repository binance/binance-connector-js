...
// @ts-ignore
import type { CurrentOpenOrdersResponseInner } from './current-open-orders-response-inner';
 ...
 */
export interface CurrentOpenOrdersResponse extends Array<CurrentOpenOrdersResponseInner> {}
