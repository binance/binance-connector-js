# **DEPRECATED** - Binance JavaScript NFT Connector
...
[![npm version](https://badge.fury.io/js/@binance%2Fnft.svg)](https://badge.fury.io/js/@binance%2Fnft)
[![npm Downloads](https://img.shields.io/npm/dm/@binance/nft.svg)](https://www.npmjs.com/package/@binance/nft)
...
[![Docs](https://img.shields.io/badge/docs-online-blue?style=flat-square)](https://binance.github.io/binance-connector-js/modules/_binance_nft.html)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

This is a client library for the Binance NFT API, enabling developers to interact programmatically with Binance's NFT trading platform. The library provides tools to launch and trade NFTs through the REST API:
...
For detailed information, refer to the [Binance API Documentation](https://developers.binance.com/docs/nft).
...
If you are upgrading to the new modularized structure, refer to the [Migration Guide](./docs/migration_guide_nft_connector.md) for detailed steps.
