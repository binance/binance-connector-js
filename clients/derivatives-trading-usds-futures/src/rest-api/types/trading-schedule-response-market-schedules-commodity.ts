...
// @ts-ignore
import type { TradingScheduleResponseMarketSchedulesCOMMODITYSessionsInner } from './trading-schedule-response-market-schedules-commoditysessions-inner';
 ...
 */
export interface TradingScheduleResponseMarketSchedulesCOMMODITY {
    /**
     *
