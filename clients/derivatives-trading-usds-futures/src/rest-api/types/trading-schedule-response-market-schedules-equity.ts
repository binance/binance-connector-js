...
// @ts-ignore
import type { TradingScheduleResponseMarketSchedulesEQUITYSessionsInner } from './trading-schedule-response-market-schedules-equitysessions-inner';
 ...
 */
export interface TradingScheduleResponseMarketSchedulesEQUITY {
    /**
     *
