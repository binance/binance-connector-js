# Binance JavaScript Dual Investment Connector
...
[![Socket Badge](https://socket.dev/api/badge/npm/package/@binance/dual-investment)](https://socket.dev/npm/package/@binance/dual-investment)
