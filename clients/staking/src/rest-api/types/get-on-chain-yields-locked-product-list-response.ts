...
// @ts-ignore
import type { GetOnChainYieldsLockedProductListResponseRowsInner } from './get-on-chain-yields-locked-product-list-response-rows-inner';
 ...
 */
export interface GetOnChainYieldsLockedProductListResponse {
    /**
     *
