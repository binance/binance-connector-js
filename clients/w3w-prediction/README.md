# Binance JavaScript W3W Prediction Connector
...
[![npm version](https://badge.fury.io/js/@binance%2Fw3w-prediction.svg)](https://badge.fury.io/js/@binance%2Fw3w-prediction)
[![npm Downloads](https://img.shields.io/npm/dm/@binance/w3w-prediction.svg)](https://www.npmjs.com/package/@binance/w3w-prediction)
![Node.js Version](https://img.shields.io/badge/Node.js-%3E=22.12.0-brightgreen)
[![Socket Badge](https://socket.dev/api/badge/npm/package/@binance/w3w-prediction)](https://socket.dev/npm/package/@binance/w3w-prediction)
[![Docs](https://img.shields.io/badge/docs-online-blue?style=flat-square)](https://binance.github.io/binance-connector-js/modules/_binance_w3w-prediction.html)
...
```bash
npm install @binance/w3w-prediction
```
