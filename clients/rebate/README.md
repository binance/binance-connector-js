# Binance JavaScript Rebate Connector
...
[![npm version](https://badge.fury.io/js/@binance%2Frebate.svg)](https://badge.fury.io/js/@binance%2Frebate)
[![npm Downloads](https://img.shields.io/npm/dm/@binance/rebate.svg)](https://www.npmjs.com/package/@binance/rebate)
![Node.js Version](https://img.shields.io/badge/Node.js-%3E=22.12.0-brightgreen)
[![Socket Badge](https://socket.dev/api/badge/npm/package/@binance/rebate)](https://socket.dev/npm/package/@binance/rebate)
[![Docs](https://img.shields.io/badge/docs-online-blue?style=flat-square)](https://binance.github.io/binance-connector-js/modules/_binance_rebate.html)
...
For detailed information, refer to the [Binance API Documentation](https://developers.binance.com/docs/rebate).
