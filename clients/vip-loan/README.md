# Binance JavaScript VIP Loan Connector
...
[![npm version](https://badge.fury.io/js/@binance%2Fvip-loan.svg)](https://badge.fury.io/js/@binance%2Fvip-loan)
[![npm Downloads](https://img.shields.io/npm/dm/@binance/vip-loan.svg)](https://www.npmjs.com/package/@binance/vip-loan)
![Node.js Version](https://img.shields.io/badge/Node.js-%3E=22.12.0-brightgreen)
[![Socket Badge](https://socket.dev/api/badge/npm/package/@binance/vip-loan)](https://socket.dev/npm/package/@binance/vip-loan)
[![Docs](https://img.shields.io/badge/docs-online-blue?style=flat-square)](https://binance.github.io/binance-connector-js/modules/_binance_vip-loan.html)
...
For detailed information, refer to the [Binance API Documentation](https://developers.binance.com/docs/vip_loan).
