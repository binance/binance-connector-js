 ...
 *
 * @export
 * @interface QueryManagedSubAccountTransferLogMasterAccountTradingResponse
 */
export interface QueryManagedSubAccountTransferLogMasterAccountTradingResponse {
    /**
     *
     * @type {Array<QueryManagedSubAccountTransferLogMasterAccountInvestorResponseManagerSubTransferHistoryVosInner>}
     * @memberof QueryManagedSubAccountTransferLogMasterAccountTradingResponse
     */
