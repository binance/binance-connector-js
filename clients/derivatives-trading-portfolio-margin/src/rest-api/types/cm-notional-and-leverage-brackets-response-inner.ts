...
// @ts-ignore
import type { CmNotionalAndLeverageBracketsResponseInnerBracketsInner } from './cm-notional-and-leverage-brackets-response-inner-brackets-inner';
 ...
 */
export interface CmNotionalAndLeverageBracketsResponseInner {
    /**
