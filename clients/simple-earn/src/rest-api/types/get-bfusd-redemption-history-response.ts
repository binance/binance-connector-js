...
// @ts-ignore
import type { GetBfusdRedemptionHistoryResponseRowsInner } from './get-bfusd-redemption-history-response-rows-inner';
 ...
 */
export interface GetBfusdRedemptionHistoryResponse {
    /**
     *
