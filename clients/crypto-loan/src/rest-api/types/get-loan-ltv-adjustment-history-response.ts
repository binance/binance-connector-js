...
// @ts-ignore
import type { GetLoanLtvAdjustmentHistoryResponseRowsInner } from './get-loan-ltv-adjustment-history-response-rows-inner';
...
export interface GetLoanLtvAdjustmentHistoryResponse {
    /**
     *
     * @type {Array<GetLoanLtvAdjustmentHistoryResponseRowsInner>}
